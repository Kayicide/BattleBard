  ...
  return (
    <div>
      ...
      <div className="flex flex-row">
        ...
        <button onClick={createGroupOnClick} disabled={isCreatingGroup} type="button" className="mt-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none">Create Group Test</button>
